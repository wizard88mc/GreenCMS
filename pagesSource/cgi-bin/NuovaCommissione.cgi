...
<div id="contents">
	...
	<input type="submit" class="button" name="submit" value="Proclamazione" />
	</fieldset>
	</form>
</div>
CONTENT
...
if ($userFormInput{'submit'} ne 0 && $userFormInput{'submit'} eq "Proclamazione") {
    print $page->redirect('NuovaProclamazione.cgi');
}
