...

{
	...
	my $pageRappStud = &openFile($siteForCGI . "organizzazione/rappresentantistudentien.html");
	...
	my $tableRapp = "
		<table summary=\"This table shows the student's representative, with their name and their email address  \">
	...
	$tableRapp .= "
		<thead>
			<tr>
			<th id=\"c1\" abbr=\"Name\" scope=\"col\">Representative</th>
	...
	while (my $representative = $rappStudentsID->fetchrow_hashref()) {   
		...
		$stringRow .= "
			<td headers=\"c1\" xml:lang=\"it\">$rappName</td>";
